...
class MOT17(BaseDataset):
    ...
    def __init__(self, opt, mode, det='FRCNN'):
        ...
        # self._videos = ['MOT17-02-FRCNN', 'MOT17-04-FRCNN', 'MOT17-05-FRCNN', 'MOT17-09-FRCNN','MOT17-10-FRCNN','MOT17-11-FRCNN','MOT17-13-FRCNN']
...
class eval_MOT17(MOT17):
    def __init__(self, opt, mode='val', vname='MOT17-01-FRCNN'):
