...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--clip_len', default=1.5, type=float, help="sparse clip time interval")
        ...
        self.parser.add_argument('--threshold', type=float, default=1.5,
    ...
    def parse(self, args=''):
        ...
        # rgb:track model;  load_model:train model
        # opt.rgb_model = os.path.join(opt.save_dir, 'model_13_valhalf.pth')
        opt.rgb_model = os.path.join(opt.save_dir, 'model_39_obdectect_trainwh.pth')
        opt.load_model = os.path.join(opt.save_dir, 'model_39_obdectect_trainwh.pth')
