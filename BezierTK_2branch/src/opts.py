...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--rgb_model', default='../../experiment/result_model/model_11.pth',
        ...
        self.parser.add_argument('--mov1_weight', type=float, default=1,
                                 help='loss weight for moving offsets.')
        self.parser.add_argument('--mov2_weight', type=float, default=1,
                                 help='loss weight for moving offsets.')
        self.parser.add_argument('--mov3_weight', type=float, default=0.01,
                                 help='loss weight for moving offsets.')
    ...
    def parse(self, args=''):
        ...
        # opt.rgb_model = os.path.join(opt.save_dir, 'model_17&20_26.pth')
