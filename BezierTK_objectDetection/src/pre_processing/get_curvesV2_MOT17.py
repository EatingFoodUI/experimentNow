...
# 改动
BezierCoeff = lambda ts: [[Mtk(5, t, k) for k in range(6)] for t in ts]
...
if __name__ == '__main__':
    ...
    arg_parser.add_argument('--forward_frames', default=9, type=int, help="frame number to extract bezier curve")
    ##
    arg_parser.add_argument('--clip_len', default=2.0, type=float, help="sparse clip time interval")
